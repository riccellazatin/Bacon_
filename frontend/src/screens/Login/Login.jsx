    ...
    return (
        <div style={{display: 'flex', flexDirection: 'column', height: '100vh', backgroundColor: '#f5f5f5', margin: 0, padding: 0}}>
            <nav className="navbar navbar-expand-lg" style={{backgroundColor: '#6b7280', padding: '1.5rem 2rem'}}>
                <div className="container-fluid" style={{padding: 0, display: 'flex', justifyConent: 'space-between', alignItems: 'center'}}>
                    <a className="navrbar-brand fw-bold" href="#home" style={{fontSize: '1.8rem', letterSpacing: '2px', color: 'white', textDecoration: 'none'}}>BACON</a>
